...
type PixKeyServiceClient interface {
	...
	Find(ctx context.Context, in *PixKeyFind, opts ...grpc.CallOption) (*Pixkey, error)
}
...
func (c *pixKeyServiceClient) RegisterPixKey(ctx context.Context, in *PixKeyRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.ajvideira.codepix.PixKeyService/RegisterPixKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pixKeyServiceClient) Find(ctx context.Context, in *PixKeyFind, opts ...grpc.CallOption) (*Pixkey, error) {
	out := new(Pixkey)
	err := c.cc.Invoke(ctx, "/github.com.ajvideira.codepix.PixKeyService/Find", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixKeyServiceServer interface {
	...
	Find(context.Context, *PixKeyFind) (*Pixkey, error)
...
func _PixKeyService_RegisterPixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.ajvideira.codepix.PixKeyService/RegisterPixKey",
	}
...
func _PixKeyService_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.ajvideira.codepix.PixKeyService/Find",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixKeyServiceServer).Find(ctx, req.(*PixKeyFind))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PixKeyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.ajvideira.codepix.PixKeyService",
